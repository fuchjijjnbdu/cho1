...
bot = telebot.TeleBot('7527768602:AAEBW16wz1DNYzn-uIc5ks8zEOA_GfXAdCk')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Mood ni hai abhi pelhe purchase kar isse:- @Anupeiejfj."
...
 Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @Anupeiejfj ."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, port, and time
            ...
            if time > 180:
                response = "Error: Buy From @Anupeiejfj For More Time"
            else:
...
Buy From :- @Anupeiejfj
Official Channel :- https://t.me/+yu6JuRbiIyllMjI1
'''
...
3. MAKE SURE YOU JOINED https://t.me/+yu6JuRbiIyllMjI1 OTHERWISE NOT WORK
